<div id="content-container">
    <div id="section-navigation">
       ...
       <?php
        ...
        $q = "SELECT name, id FROM categories ORDER BY position ASC";
        $r = mysqli_query($dbc, $q);
            confirm_query($r, $q);
        
        // Lay categories tu csdl
        while($cats = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
            echo "<li><a href='index.php?cid={$cats['id']}'";
                if($cats['id'] == $cid) echo "class='selected'";
            echo ">".$cats['name']. "</a>";
            
            // Cau lenh truy xuat pages
            $q1 = "SELECT page_name, id FROM pages WHERE category_id={$cats['id']} ORDER BY position ASC";
            ...
            while($pages = mysqli_fetch_array($r1, MYSQLI_ASSOC)) { 
                echo "<li><a href='index.php?pid={$pages['id']}'";
                    if($pages['id'] == $pid) echo "class='selected'";
